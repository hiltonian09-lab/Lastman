          ...
          <tbody>
            {table.map((row) => (
              ...
              >
                ...
                <td className="py-3 pr-2 text-foreground-muted">{row.won}</td>
                <td className="py-3 pr-2 text-foreground-muted">{row.drawn}</td>
                <td className="py-3 pr-2 text-foreground-muted">{row.lost}</td>
                <td className="py-3 pr-2 text-foreground-muted">{row.goalsFor}</td>
                <td className="py-3 pr-2 text-foreground-muted">{row.goalsAgainst}</td>
                <td className="py-3 pr-2 text-foreground-muted">{row.goalDifference}</td>
